...
CREATE INDEX IF NOT EXISTS idx_youtube_crawler_invitations_org ON invitations(org_id);
CREATE INDEX IF NOT EXISTS idx_youtube_crawler_invitations_token ON invitations(token);
CREATE INDEX IF NOT EXISTS idx_youtube_crawler_credentials_org ON credentials(org_id);
CREATE INDEX IF NOT EXISTS idx_youtube_crawler_credentials_provider ON credentials(provider);
