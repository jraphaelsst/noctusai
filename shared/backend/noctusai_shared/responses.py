"""
Standardized response utilities for all NoctusAI APIs.

Provides consistent JSON response shapes for success, pagination,
deletion, and acknowledgment responses.
"""
