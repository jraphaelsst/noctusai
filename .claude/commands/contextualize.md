...
5. **Print the mental model** before touching anything (the fresh-agent contract): seed-first · living/self-improving methodology · 7-way sync · codebase is source of truth · no silent errors · branching-first · AST-first · fix-on-contact.
