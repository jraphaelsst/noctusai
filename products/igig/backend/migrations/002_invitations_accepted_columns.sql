...
-- (Phase 2 of igig-team-router-accept-real-adapter, 2026-05-11).
--
-- This is the canonical-scaffold migration that propagates to every new
-- product via the igig → templates/product-igig sync (see pre-commit hook).

ALTER TABLE igig.invitations
