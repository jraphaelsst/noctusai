...
-- ── Phase 3: youtube timeseries ──────────────────────────────────────────────
-- Mirrors 009_youtube_timeseries.sql (forward-only patch for live DBs).
-- RLS shape: org-scoped SELECT TO authenticated + service_role write (same as
-- video_cache above). snapshot_runs has no org_id → service_role only.
-- ─────────────────────────────────────────────────────────────────────────────
...
-- No org_id: internal scheduling-guard table, service_role only.
...
-- ─── end Phase 3: youtube timeseries ───
