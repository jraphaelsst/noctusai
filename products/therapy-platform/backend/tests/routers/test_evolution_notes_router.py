...
class TestCreateEvolutionNote:
    ...
    def test_create_soap_note(self, client):
        ...
        resp = client.post("/api/evolution-notes", json={
            "patient_id": "patient-001",
            "formato": "soap",
    ...
    def test_create_note_patient_forbidden(self, patient_client):
        ...
        resp = patient_client.post("/api/evolution-notes", json={
            "patient_id": "patient-001",
            "formato": "soap",
            "subjetivo": "Teste",
        })
...
class TestListEvolutionNotes:
    """GET /api/evolution-notes/paciente/{patient_id}"""
    ...
    def test_list_notes(self, client):
        ...
        resp = client.get("/api/evolution-notes/paciente/patient-001")
        assert resp.status_code == 200
        body = resp.json()
        assert "data" in body
    ...
    def test_list_notes_patient_forbidden(self, patient_client):
        ...
        resp = patient_client.get("/api/evolution-notes/paciente/patient-001")
        assert resp.status_code == 403
    ...
    def test_list_notes_admin_denied(self, admin_client):
        ...
        resp = admin_client.get("/api/evolution-notes/paciente/patient-001")
        assert resp.status_code == 403


class TestGetEvolutionNote:
    """GET /api/evolution-notes/{note_id}"""

    def test_get_note(self, client):
        """Therapist gets their own note."""
        client._mock_supabase.set_table_data("evolution_notes", [SAMPLE_NOTE_SOAP])
        resp = client.get("/api/evolution-notes/note-001")
        assert resp.status_code == 200
        assert "data" in resp.json()
    ...
    def test_get_note_not_found(self, client):
        ...
        resp = client.get("/api/evolution-notes/nonexistent")
...
class TestUpdateEvolutionNote:
    """PATCH /api/evolution-notes/{note_id}"""

    def test_update_note(self, client):
        """Therapist updates their own note."""
        client._mock_supabase.set_table_data("evolution_notes", [SAMPLE_NOTE_SOAP])
        resp = client.patch("/api/evolution-notes/note-001", json={
    ...
    def test_update_note_not_found(self, client):
        """Non-existent note returns 404."""
        client._mock_supabase.set_table_data("evolution_notes", [])
        resp = client.patch("/api/evolution-notes/nonexistent", json={
            "plano": "Teste",
        })
        assert resp.status_code == 404
    ...
    def test_update_note_patient_forbidden(self, patient_client):
        ...
        resp = patient_client.patch("/api/evolution-notes/note-001", json={
            "plano": "Teste",
        })
        assert resp.status_code == 403
