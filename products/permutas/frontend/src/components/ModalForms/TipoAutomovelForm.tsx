...
const TipoAutomovelForm = ({ onSuccess, onClose }: Props) => {
  const api = useAxios()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await api.post('/tipo-automovel/', {
        nome: nome.trim()
      })
      ...
      console.error('Error creating tipo automovel:', error)
      swal.fire({
...
export default TipoAutomovelForm
