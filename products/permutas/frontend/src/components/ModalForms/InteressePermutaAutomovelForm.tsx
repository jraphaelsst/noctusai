...
export type InteressePermutaAutomovelData = {
  tipo_imovel: string
...
type Props = {
  onAdd: (data: InteressePermutaAutomovelData) => void
  onClose: () => void
  initialData?: InitialData
}

const InteressePermutaAutomovelForm = ({ onAdd, onClose, initialData }: Props) => {
  ...
  return (
    <>
      <Description>
        Defina que tipo de imóvel o proprietário deste veículo aceita em troca. 
...
export default InteressePermutaAutomovelForm
