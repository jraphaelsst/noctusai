...
export type InteresseImovelData = {
  tipo_imovel: string
  zona: string
  cep: string
  estado: string
...
type Props = {
  onAdd: (data: InteresseImovelData) => void
  onClose: () => void
  initialData?: InitialData
}

const InteresseImovelForm = ({ onAdd, onClose, initialData }: Props) => {
  ...
  return (
    <>
      <Form onSubmit={handleSubmit}>
        ...
        <Button type="submit">Adicionar Interesse Imobiliário</Button>
      </Form>
...
export default InteresseImovelForm
