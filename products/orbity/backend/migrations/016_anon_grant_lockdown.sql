-- ============================================================================
-- 016_anon_grant_lockdown.sql — Orbity (orbity)
--
-- Closes the schema-wide `anon` exposure inherited from `001_orbity.sql`
...
--   ALTER DEFAULT PRIVILEGES IN SCHEMA orbity GRANT ALL ON TABLES TO anon, ...;
--
...
-- `products/orbity/backend/migrations/*.sql` for `TO anon`, `FOR ... anon`,
...
REVOKE ALL ON ALL TABLES IN SCHEMA orbity FROM anon;
ALTER DEFAULT PRIVILEGES IN SCHEMA orbity REVOKE ALL ON TABLES FROM anon;

-- `todos_veem_producao` (001_orbity.sql) is a deliberate PUBLIC-role
...
GRANT SELECT ON orbity.status_pagina TO anon;
