      ...
      <section className="py-20 sm:py-28 px-4 text-center bg-gradient-to-b from-primary/5 to-background flex-1 flex flex-col items-center justify-center">
        <div className="max-w-3xl mx-auto space-y-6">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 text-primary text-sm font-medium">
            ...
            NoctusAI Knowledge Extractor
          </div>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-foreground">
            Transforme cursos em conhecimento buscável
          </h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Extrai transcrições e resumos das suas aulas, organiza tudo num
            catálogo e responde perguntas a partir do conteúdo processado.
          </p>
