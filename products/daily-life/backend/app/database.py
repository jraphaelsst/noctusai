...
All daily-life product tables live in the "daily_life" schema.
The make_supabase_client call passes schema="daily_life" so supabase-py sends
...
def get_supabase_client(access_token: Optional[str] = None) -> Client:
    """
    Create a Supabase client targeting the "daily_life" schema.
