...
class TestDashboardResumo:
    ...
    def test_dashboard_with_data(self, client):
        client._mock_supabase.set_table_data("clientes", [
            {"id": "c1", "etapa_funil": "prospeccao", "created_at": "2026-02-01T10:00:00", "valor_estimado": 100000},
            {"id": "c2", "etapa_funil": "qualificacao", "created_at": "2026-02-15T10:00:00", "valor_estimado": 200000},
        ])
