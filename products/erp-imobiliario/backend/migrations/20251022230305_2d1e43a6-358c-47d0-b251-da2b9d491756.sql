-- Corrigir função de distribuição: dividir para baixo, projetar para cima
...
BEGIN
  ...
  CASE NEW.tipo
    ...
    WHEN 'mensal' THEN
      ...
      ON CONFLICT (usuario_id, tipo, categoria, data_prazo) 
      WHERE categoria_custom IS NULL
      DO NOTHING;
    ...
    WHEN 'semanal' THEN
      ...
      -- Projetar meta mensal (assumindo 4 semanas)
