...
GRANT ALL ON ALL SEQUENCES IN SCHEMA community TO anon, authenticated, service_role;
ALTER DEFAULT PRIVILEGES IN SCHEMA community GRANT ALL ON TABLES TO anon, authenticated, service_role;
ALTER DEFAULT PRIVILEGES IN SCHEMA community GRANT ALL ON SEQUENCES TO anon, authenticated, service_role;
...
CREATE TABLE community.status_pagina (
...
ALTER TABLE community.status_pagina ENABLE ROW LEVEL SECURITY;
...
CREATE POLICY "todos_veem_producao" ON community.status_pagina
...
ALTER TABLE community.invitations ENABLE ROW LEVEL SECURITY;
...
CREATE INDEX idx_community_invitations_org ON community.invitations(org_id);
CREATE INDEX idx_community_invitations_token ON community.invitations(token);
