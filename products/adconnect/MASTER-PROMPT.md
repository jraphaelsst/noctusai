...
- Fresh-clone bootstrap auto-hydrates every `products/*/backend/requirements.txt` into the shared venv (`scripts/bootstrap/bootstrap-worktree.sh` + `scripts/setup.sh`, 2026-05-11) — ¬ per-product `pip install -r` step needed.
