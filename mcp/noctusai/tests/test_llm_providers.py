...
class TestAutoRegistration:
    def test_importing_llm_registers_three_providers(self):
        ...
        import noctusai_lib.llm  # noqa: F401
        from noctusai_lib.llm import list_providers
...
class TestAnthropicReal:
    ...
    def test_missing_key_raises_not_configured(self):
        ...
        from noctusai_lib.llm.providers.anthropic_provider import AnthropicProvider
    ...
    def test_split_system_and_messages_separates_system(self):
        from noctusai_lib.llm.providers.anthropic_provider import _split_system_and_messages
...
class TestGeminiReal:
    ...
    def test_translate_messages_renames_assistant_to_model(self):
        from noctusai_lib.llm.providers.gemini_provider import _translate_messages
...
class TestOpenAIProviderStructure:
    def test_no_client_without_api_key(self):
        from noctusai_lib.llm import LLMNotConfigured
        from noctusai_lib.llm.providers.openai_provider import OpenAIProvider
