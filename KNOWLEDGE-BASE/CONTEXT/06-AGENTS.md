...
**189 tools total** (auto-counted from `mcp/noctusai/tools/`).
...
→ `KB § PATTERNS/branching-first-orchestration` (dispatch) · `KB § 01-PHILOSOPHY.md § Context budget discipline` (MCP keep-list) · `.claude/agents/engineer-seed.md`
