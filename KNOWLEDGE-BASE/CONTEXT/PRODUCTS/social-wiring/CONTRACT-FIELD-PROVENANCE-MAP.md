...
| Serasa Crednet (`serasa_crednet`) | cliente | `cpf`, `data_nascimento`, `nome`, `nome_mae` | `noctusai_lib.integrations.documents.serasa_crednet.make_crednet_extractor` | `serasa_crednet` | `cliente_card_upload`, `parte_painel_upload` |
...
| Guia do ITBI (`guia_itbi`) | atendimento | `valor_transacao` | `noctusai_lib.integrations.documents.guia_itbi.make_guia_itbi_extractor` | `guia_itbi` | `atendimento_card_upload` |
