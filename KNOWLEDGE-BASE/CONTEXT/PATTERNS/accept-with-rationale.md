...
- **Scope:** retired. Canonical home: `seed/backend/lib/noctusai_lib/integrations/vista/`. Two consumers: `mcp/vista/` (in-repo MCP) + ERP showcase router/service. ERP-side `vista_showcase_types.py` retains the 4 router-response wrappers.
