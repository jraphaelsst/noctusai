...
This is the Stage-4 codification of the rule (memory `feedback_product_icon_must_be_registered` → this doc + `CLAUDE/frontend.md` → the keeper). See `KB § PATTERNS/methodology-codification-pipeline.md`.
