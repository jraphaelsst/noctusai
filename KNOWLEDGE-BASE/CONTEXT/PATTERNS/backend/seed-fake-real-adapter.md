...
- `KB § PATTERNS/architect/seed-lib-layout.md` — the 6-layer module taxonomy this pattern lives within
- `KB § PATTERNS/backend/scheduling-seed.md` — example of an IO-EXEMPT seed module (`domain.scheduling`)
- `KB § PATTERNS/backend/whatsapp-chatbot-seed.md` — wiring recipe for the chatbot/whatsapp combo
