...
- **Container freshness** — if the running container serves code this session changed, confirm runtime parity (`KB § PATTERNS/containerization.md § 12b`). *Even a fresh container can be prod-wrong if the code assumed dev parity* — this rule is the layer above freshness.
