...
- Sibling primitives: `KB § PATTERNS/common/ast.md` (AST-first rule), `KB § PATTERNS/common/agent-reading-discipline.md` (narrow-read + Explore delegation), `KB § PATTERNS/architect/seed-absorption.md` (`noctus.hound.scan` family — feeders for the deferred mined layer).
