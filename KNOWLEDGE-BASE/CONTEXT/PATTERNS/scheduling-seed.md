...
- **Audit logging of slot proposals.** Use `noctusai_lib.domain.ai.tool_audit` if the slot proposal is mediated by an LLM tool call (see `KB § PATTERNS/llm-tool-audit.md`).
