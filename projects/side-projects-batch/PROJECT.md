...
**1.c `therapy-scheduler-for-retention` — drive to ✅.**
- [ ] Phase 0 audit + child §2 fill from §7 round.
- [ ] Build `app/scheduler.py` modeled on mailing/PF/erp scheduler patterns; wire into `main.py`.
- [ ] Tests + verification.
