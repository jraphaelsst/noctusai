...
class CrawlerSettings(ProductSettings):
    """YouTube Crawler settings — domain extensions on top of the framework
    baseline.
    ...
    # `youtube_crawler.credentials` keyed by (org_id, 'google_calendar').
    ...
    # The stored credential row lives in `youtube_crawler.credentials`
