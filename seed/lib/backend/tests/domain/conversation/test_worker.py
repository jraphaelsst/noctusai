...
from noctusai_lib.domain.conversation.worker import ConversationWorker
...
class FakeBufferService:
    ...
    def mark_conversation_claimed(self, conversation_id: str) -> None:
        self.claimed.append(conversation_id)
...
def test_worker_processes_due_conversations_and_claims_them() -> None:
    """Ported verbatim from sibling
    `tests/test_conversation_worker.py:test_worker_processes_due_conversations_and_claims_them`."""
