...
Promoted from `products/social-wiring/backend/app/services/whatsapp_identity.py`
2026-09-17 (`community` module 3 seed slice) — pure WAHA shape with zero
social-wiring domain, already importing only `lid_auth.is_lid` /
`normalize_phone`. social-wiring's own copy is now a re-export shim; see
