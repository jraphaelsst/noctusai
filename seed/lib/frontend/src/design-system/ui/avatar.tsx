/**
 * Avatar — Radix-backed avatar primitive.
 *
 * Design-system copy of SW's local shadcn wrapper
 * (`products/social-wiring/frontend/src/components/ui/avatar.tsx`) —
 * markup/classes/data-attributes kept byte-for-byte so SW's card-hub
 * (Membros popover) can swap onto this import with zero visual change at
 * desktop
