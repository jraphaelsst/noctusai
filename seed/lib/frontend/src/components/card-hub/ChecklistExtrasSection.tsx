 ...
 *
 * MOVED from `products/social-wiring/frontend/src/components/card/ChecklistExtrasSection.tsx` into the
...
import type { ChecklistExtra, ChecklistExtraTipo } from "./types";
